...
#endif // not EIGEN_PARSED_BY_DOXYGEN
{
  ...
  public:
    ...
    typename const VectorBlock<const Derived> segment(Index start, Index size) const;

    SegmentReturnType head(Index size);
    typename const VectorBlock<const Derived> head(Index size) const;

    SegmentReturnType tail(Index size);
    typename const VectorBlock<const Derived> tail(Index size) const;
